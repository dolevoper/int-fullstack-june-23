            ...
            const comnum = Number (Math.floor(Math.random() *10 + 1));
                ...
                while (usernum !== comnum) {
                    if (usernum > 10 || usernum < 1 || isNaN(usernum)) {
                        usernum = Number( prompt("You entered an invalid text, please enter a valid number between 1-10"));
                    }
    ...
    else if (lowAndTrimDifficulty === "hard" || lowAndTrimDifficulty === "2" || lowAndTrimDifficulty === "2.hard" || lowAndTrimDifficulty === "2hard")
    {
        ...
        if (usernum === null) {
            ...
            const comnum = Number (Math.floor(Math.random() *100 + 1));
                let guessesCount = 1;
                while (usernum !== comnum) {
                    if (usernum > 100 || usernum < 1 || isNaN(usernum)) {
                        usernum = Number( prompt("You entered an invalid text, please enter a valid number between 1-100"));
                    }
                    else if (usernum < comnum) {
                        guessesCount ++;
    ...
    else if (lowAndTrimDifficulty === "impossible" || lowAndTrimDifficulty === "3" || lowAndTrimDifficulty === "3.impossible" || lowAndTrimDifficulty === "3impossible")
    {
        ...
        if (usernum === null) {
            ...
            const comnum = Number (Math.floor(Math.random() *1000 + 1));
                let guessesCount = 1;
                while (usernum !== comnum) {
                    if (usernum > 1000 || usernum < 1 || isNaN(usernum)) {
                        usernum = Number( prompt("You entered an invalid text, please enter a valid number between 1-1000"));
                    }
                    else if (usernum < comnum) {
                        guessesCount ++;
