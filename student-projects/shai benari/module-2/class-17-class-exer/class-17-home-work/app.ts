...
const arrayLength = Number(prompt("Enter the number of item in the array"));
for (let i=0; i < arrayLength; i++){
    const number = Number(prompt("Enter a number to add to the array"));
    medianArray.push(number);
} 
alert("The array you enterd is: " + medianArray);
const madianLength = medianArray.length;
const resultMedian = madian(madianLength);
alert("the median of the array is: " + resultMedian);
...
//    alert(madianLength);
   ...
   return(resultMedian)
    ...
    const lowLimet =Number(medianArray[(madianLength)/2 -1]);
    const upLimet = Number(medianArray[(madianLength)/2 ]);
    // alert(upLimet);
    // alert(lowLimet);
    const resultMedian = (upLimet+lowLimet)/2;
    return(resultMedian);
