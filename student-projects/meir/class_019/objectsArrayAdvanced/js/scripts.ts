...
const galleryParent = document.querySelector("#gallery") as HTMLDivElement;

const myDiv = document.createElement('div');
myDiv.className = 'flex-content';
galleryParent.appendChild(myDiv);

myProps.forEach((value, index) => {

    const galleryChild = document.createElement('div');
    myDiv.appendChild(galleryChild);
    ...
    galleryChild.insertAdjacentHTML('afterbegin',myContent);
